...
<body>
    ...
    <main class="main">
        ...
        <br> <br>
        <h1 class="x">Hottest Phones</h1><br>
        <div class="container2">

           
            
            <div class="item">
                <img id="im1" src="realmec33.jpeg"/>
                <figcaption>
                    <center><a id="a2" href="">Realme  C33 </a></center>
                </figcaption>
            
            </div>
            <div class="item">
                <img id="im2" src="c31.jpeg"/>
                <figcaption>
                    <center><a id="a2" href="">Realme C31</a></center>
                </figcaption>
            </div>
            <div class="item">
                <img id="im2" src="c11.jpeg"/>
                <figcaption>
                    <center><a id="a2" href="">Realme C11</a></center>
                </figcaption>
            </div>
            <div class="item">
                <img id="im2" src="c30.jpeg"/>
                <figcaption>
                    <center><a id="a2" href="">Realme C30</a></center>
                </figcaption>
            </div>
            <div class="item">
                <img id="im2" src="c55.jpeg"/>
                <figcaption>
                    <center><a id="a2" href="">Realme C55</a></center>
                </figcaption>
            </div>
            <div class="item">
                <img id="im2" src="realme10.jpeg"/>
                <figcaption>
                    <center><a id="a2" href="">Realme 10</a></center>
                </figcaption>
            </div>
            
        </div>
        <h1 class="x" >New Arrival</h1>
        <div class="container3">
            <div class="d1"> 
               <img src="d1.jpg"  height="670px"/>
            </div>
            <div class="d2"> 
                <img src="d2.jpeg" height="300px" width="510px"  />
            </div>
            <div class="d3"> 
                <img src="d3.jpeg" height="300px" width="510px"   />
            </div>
        </div>
        <div class="container4">
            
        </div>
        <h1 class="x">Hottest Audio</h1>
        <div class="container5">
            <div class="item2">
                <img id="im2" src="buds air1.jpeg"/>
                <figcaption>
                    <center><a id="a2" href="">Realme  Buds Air1 </a></center>
                </figcaption>
            
            </div>
            <div class="item2">
                <img id="im2" src="techlife.jpeg"/>
                <figcaption>
                    <center><a id="a2" href="">Realme  Techlife </a></center>
                </figcaption>
            
            </div>
            <div class="item2">
                <img id="im2" src="buds q1.jpeg"/>
                <figcaption>
                    <center><a id="a2" href="">Realme  Buds Q1 </a></center>
                </figcaption>
            
            </div>
            <div class="item2">
                <img id="im2" src="necklace.jpeg"/>
                <figcaption>
                    <center><a id="a2" href="">Realme  Necklace </a></center>
                </figcaption>
            
            </div>
            <div class="item2">
                <img id="im2" src="necklace2.jpeg"/>
                <figcaption>
                    <center><a id="a2" href="">Realme  Necklace 2</a></center>
                </figcaption>
            
            </div>
            <div class="item2">
                <img id="im2" src="speaker.jpeg"/>
                <figcaption>
                    <center><a id="a2" href="">Poket Bluetooth Speaker</a></center>
                </figcaption>
